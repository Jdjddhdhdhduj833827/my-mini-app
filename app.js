 ...
 const REG_LINK = "https://u3.shortink.io/register?utm_campaign=838492&utm_source=affiliate&utm_medium=sr&a=M2nsxBfYsujho1&ac=craft_academy&code=WELCOME50";
  ...
  const T = {
    ru: {
      ...
      gateText:
        "gateText:
  "CRAFT ANALYTICS — бесплатный AI-интерфейс. Для активации доступа зарегистрируйтесь по ссылке ниже и активируйте аккаунт пополнением баланса, после чего вернитесь и нажмите “Открыть интерфейс”.",”.",
